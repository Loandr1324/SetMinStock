...
1.1. Не учитываем Кратность и Комплектность. В этом режиме Программа в независимости от установленной Кратности и
Комплектности в файле принимает значение Кратности и Комплектности равной 1. Для перехода в этот режим необходимо
нажать Enter.
1.2. Если необходимо учитывать Кратность и Комплектность, то нажимаем 1. Далее выбираем режим работы.
1.2.1. Присваиваем значение кратности программой. Комплектность не учитываем.
В этом режиме программа запросит какое значения Кратности установить.
В независимости от установленного значения Кратности в файле программа будет брать установленное значение Кратности.
В независимости от установленного значения Комплектности в файле программа будет брать значение равное 1.
1.2.2. Ограничиваем максимальное значение Кратности и Комплектности.
